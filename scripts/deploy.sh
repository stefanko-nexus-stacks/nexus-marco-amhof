...
SSH_HOST="ssh-marco-amhof.nona.company"
...
KESTRA_URL=https://kestra-marco-amhof.nona.company
EOF
...
CB_SERVER_URL=https://cloudbeaver-marco-amhof.nona.company
...
REDIRECT_URL=https://hoppscotch-marco-amhof.nona.company
WHITELISTED_ORIGINS=https://hoppscotch-marco-amhof.nona.company
VITE_BASE_URL=https://hoppscotch-marco-amhof.nona.company
VITE_SHORTCODE_BASE_URL=https://hoppscotch-marco-amhof.nona.company
VITE_ADMIN_URL=https://hoppscotch-marco-amhof.nona.company/admin
VITE_BACKEND_GQL_URL=https://hoppscotch-marco-amhof.nona.company/backend/graphql
VITE_BACKEND_WS_URL=wss://hoppscotch-marco-amhof.nona.company/backend/graphql
VITE_BACKEND_API_URL=https://hoppscotch-marco-amhof.nona.company/backend/v1
...
PREFECT_UI_API_URL=https://prefect-marco-amhof.nona.company/api
EOF
...
LAKEFS_GATEWAYS_S3_DOMAIN_NAME=s3.lakefs-marco-amhof.nona.company
...
NC_PUBLIC_URL=https://nocodb-marco-amhof.nona.company
                    ...
                    SECRETS_PAYLOAD=$(cat <<SECRETS_EOF
{
  ...
  "secrets": [
    ...
    {"secretKey": "GITEA_REPO_URL", "secretValue": "https://git-marco-amhof.nona.company/${GITEA_REPO_OWNER:-$ADMIN_USERNAME}/${REPO_NAME:-nexus-${DOMAIN//./-}-gitea}.git", "tagIds": ["$GITEA_TAG"]},
    ...
    cron: \"*/15 * * * *\"'" >/dev/null 2>&1 || true
            ...
            if echo "$ENABLED_SERVICES" | grep -qw "woodpecker" && [ -n "$WOODPECKER_AGENT_SECRET" ]; then
                ...
                OAUTH_RESULT=$(ssh nexus "curl -s -X POST 'http://localhost:3200/api/v1/user/applications/oauth2' \
                    ...
                    -d '{
                        \"name\": \"Woodpecker CI\",
                        \"redirect_uris\": [\"https://woodpecker-marco-amhof.nona.company/authorize\"],
...
if echo "$ENABLED_SERVICES" | grep -qw "wikijs" && [ -n "$WIKIJS_ADMIN_PASS" ]; then
    (
        ...
        SETUP_PAYLOAD=$(jq -n \
            ...
            --arg url "https://wiki-marco-amhof.nona.company" \
